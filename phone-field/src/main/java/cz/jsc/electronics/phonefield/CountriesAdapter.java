 ...
 */
public class CountriesAdapter extends ArrayAdapter<cz.jsc.electronics.phonefield.Country> implements SpinnerAdapter {

    private final LayoutInflater mInflater;

    CountriesAdapter(Context context, List<cz.jsc.electronics.phonefield.Country> countries) {
